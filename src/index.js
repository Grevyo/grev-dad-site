...
function normalizeProfileInput(body) {
  ...
  return { display_name, profile_title, bio, location, website_url, steam_url, leetify_url, avatar_url, banner_url, profile_background_url, favourite_colour, profile_accent_colour, profile_background_colour, profile_layout, show_level, show_rank, show_badges, show_last_active };
}
