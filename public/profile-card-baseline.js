(() => {
  ...
  function create(value,options={}){const profile=normalize(value);const root=previousCreate(profile,{...options,includeTiles:false});if(options.variant)root.dataset.cardVariant=options.variant;apply(root,profile,options);return root;}
