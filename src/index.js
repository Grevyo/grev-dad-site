...
const PROFILE_LINK_VISIBILITY_KEYS = new Set(['website','steam','leetify','refrag','spotify','soundcloud','youtube_music']);
...
function normalizeProfileInput(body, existingProfile = {}) {
  ...
  let website_url, steam_url, spotify_url, soundcloud_url, youtube_music_url;
