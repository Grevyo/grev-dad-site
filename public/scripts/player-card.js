(function(){
  ...
  window.renderPlayerCard=function(profile,options={}){
    const p=profile||{}; const o={showXp:true,showUserId:false,useCardSettings:true,variant:'default',...options};
