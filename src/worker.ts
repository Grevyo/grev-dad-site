...
const DASHBOARD_ASSETS = new Set([
  ...
  '/platform-profile.css','/platform-profile.js','/profile-card-popover.css','/profile-card-popover.js','/site-shell.css','/site-shell.js','/site-platform.css','/site-platform.js','/chat-ui.css','/chat-ui.js','/chat-tabs.css','/chat-tabs.js','/feedback-centre.css','/feedback-centre.js','/hub.html','/hub.css','/hub.js'
]);
...
export default {
  async fetch(request: Request, env: AppEnv): Promise<Response> {
    ...
    if (request.method === 'GET' && url.pathname === '/dashboard.js') return bundledAsset(request, env, ['/dashboard-experience.js','/platform-dashboard.js','/dashboard-advanced.js','/dashboard-collaboration.js','/platform-live-quick.js','/feedback-centre.js'], 'application/javascript; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/dashboard.css') return bundledAsset(request, env, ['/dashboard-experience.css','/platform-dashboard.css','/dashboard-advanced.css','/dashboard-collaboration.css','/platform-completion.css','/feedback-centre.css'], 'text/css; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/profile-editor-unified.js') return bundledAsset(request, env, ['/profile-editor-unified-a11y.js','/profile-experience.js','/platform-profile.js','/site-shell.js','/site-platform.js','/profile-card-popover.js','/chat-ui.js','/chat-tabs.js','/platform-live-quick.js','/profile-guestbook-enhanced.js','/feedback-centre.js'], 'application/javascript; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/profile-editor-unified.css') return bundledAsset(request, env, ['/profile-experience.css','/platform-profile.css','/site-shell.css','/site-platform.css','/profile-card-popover.css','/chat-ui.css','/chat-tabs.css','/platform-completion.css','/feedback-centre.css'], 'text/css; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/admin.js') return bundledAsset(request, env, ['/site-shell.js','/site-platform.js','/profile-card-popover.js','/chat-ui.js','/chat-tabs.js','/feedback-centre.js'], 'application/javascript; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/admin-dashboard.js') return bundledAsset(request, env, ['/site-shell.js','/site-platform.js','/profile-card-popover.js','/chat-ui.js','/chat-tabs.js','/feedback-centre.js'], 'application/javascript; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/feature.js') return bundledAsset(request, env, ['/site-shell.js','/site-platform.js','/profile-card-popover.js','/chat-ui.js','/chat-tabs.js','/feedback-centre.js'], 'application/javascript; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/app.js') return bundledAsset(request, env, ['/site-shell.js','/site-platform.js','/profile-card-popover.js','/chat-ui.js','/chat-tabs.js','/feedback-centre.js'], 'application/javascript; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/styles.css') return bundledAsset(request, env, ['/site-shell.css','/site-platform.css','/profile-card-popover.css','/chat-ui.css','/chat-tabs.css','/feedback-centre.css'], 'text/css; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/hub.js') return bundledAsset(request, env, ['/site-shell.js','/site-platform.js','/chat-ui.js','/chat-tabs.js','/feedback-centre.js'], 'application/javascript; charset=utf-8');
    if (request.method === 'GET' && url.pathname === '/hub.css') return bundledAsset(request, env, ['/site-shell.css','/site-platform.css','/chat-ui.css','/chat-tabs.css','/feedback-centre.css'], 'text/css; charset=utf-8');
